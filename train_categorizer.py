...
#
# LINGUISTIC ALIGNMENT RULES:
# Concord and Verb Extensions are modeled via task tokens <CUR> and <REV>.
# Verbs are processed under the canonical templating structural syntax:
#   [SM] - [TAM] - [OM] - ROOT - [EXT] - FV
# Suffix transformations match high-value derivational templates:
#   Infinitive:  oku- + ROOT
#   Agent Noun:  omu- + ROOT + -i
#   Instrument:  oshi- + ROOT + -o
#   Abstract:    ou- + ROOT
# =====================================================================
...
def train_transformer_system():
    ...
    # Pad back to SEQ_LENGTH so dimensions match (32 vs 32)
